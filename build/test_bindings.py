...
def plan_pmm_trajectory(planner_config_file, waypoints_config_file, sampling_period=0.05, csv_path=None):
    # Load YAML
    ...
    alpha_red_factor = planner_config['velocity_optimization']['first_run']['alpha_reduction_factor']
    ...
    alpha_red_factor2 = planner_config['velocity_optimization']['second_run']['alpha_reduction_factor']
    ...
    traj = pmm_planner.PMM_MG_Trajectory3D(
        ...
        max_acc_norm, max_vel_norm, dT_precision,
        max_iter, alpha, alpha_red_factor, alpha_min_thr,
        TD_max_iter, TD_acc_precision, True,  # second_round_opt
        max_iter2, alpha2, alpha_red_factor2, alpha_min_thr2,
        drag, debug
    )
...
if __name__ == "__main__":
    ...
    waypoints_config_file = "../config/waypoints/my_traj.yaml"
